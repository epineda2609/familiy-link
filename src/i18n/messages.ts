...
export const messages = {
  ...
  pt: {
    ...
    "empty.search.desc": "Amplie os filtros ou revise a ortografia do nome.",
    "empty.matches.title": "Sem correspondências pendentes",
    "empty.matches.desc": "O motor não encontrou casos para revisar com este filtro.",
    "empty.integrations.title": "Ainda não há envios",
    "empty.integrations.desc": "Mensagens automáticas e de teste aparecerão aqui.",
