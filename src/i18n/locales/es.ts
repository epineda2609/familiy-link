...
const esDict = {
  ...
  "rescue.differentiator.title": "Trazable desde el primer instante",
  "rescue.differentiator.desc": "Apenas una persona es encontrada o rescatada, BASUF genera un ID temporal y un código humano que la acompaña por brigadas, ambulancias, hospitales, refugios y ONG.",
  "rescue.home.hint": "Innovación clave: identidad rastreable desde el rescate.",
