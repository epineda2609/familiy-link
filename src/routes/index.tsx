          ...
          <div className="mx-auto max-w-7xl px-4 pb-16">
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-1 font-semibold">{t("rescue.differentiator.title")}</p>
        ...
        <section className="mx-auto max-w-7xl px-4 py-16">
          <div className="mb-8 flex items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">{t("home.disasters.subtitle")}</p>
            </div>
            <Link
              to="/search"
                ...
                >
                  ...
                  {d.magnitude && (
                    <p className="mt-2 text-xs text-muted-foreground">
                      <T k="audit.routes.index.magnitud" />{" "}
                      <span className="font-semibold text-foreground">{d.magnitude}</span>
                    </p>
                  )}
                  {(() => {
                    ...
                    return (
                      <>
                        <p className="mt-3 text-xs text-muted-foreground">
                          ...
                          <T k="audit.routes.index.reportesRegistrados" />
                        </p>
                        <p className="mt-1 text-xs text-muted-foreground">
                          <span className="font-semibold text-destructive">
                            {c.potentialMatches}
                          </span>{" "}
                          <T k="audit.routes.index.posiblesCoincidencias" />
                        </p>
                        <p className="mt-1 text-xs text-muted-foreground">
                          <span className="font-semibold text-urgent-foreground">
                            {c.verifiedCases}
                          </span>{" "}
                          <T k="audit.routes.index.casosVerificados" />
                        </p>
                      </>
                    );
                  })()}
